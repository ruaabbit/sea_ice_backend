...
###
 ...
 # @LastEditTime: 2025-01-08 14:21:25
 # @FilePath: /Oscar/multimodal-n25/data/sic/gen_npy_data_path.sh
 # @Description: 生成nc数据路径
 # 
 # Copyright (c) 2024 by ${git_name_email}, All Rights Reserved. 
### 

DATA_DIR=/data/Arctic_Ice_Forecasting_Datasets/Sea_Ice_Concentration
TEXTFILE=/home/ubuntu/sea_ice_backend/seaice/cross_modality/data/sic_path.txt
