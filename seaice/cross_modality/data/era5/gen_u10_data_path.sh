...
###
 ...
 # @LastEditTime: 2025-01-09 22:57:25
 # @FilePath: /Oscar/multimodal-n25/data/era5/gen_u10_data_path.sh
 # @Description: 生成nc数据路径
 # 
 # Copyright (c) 2024 by ${git_name_email}, All Rights Reserved. 
### 

DATA_DIR=/data/Arctic_Ice_Forecasting_Datasets/ERA5/u10
TEXTFILE=/home/ubuntu/sea_ice_backend/seaice/cross_modality/data/u10_path.txt
